...
@FunctionalInterface
interface ChangeToUpper{
	String changetoupper(String a);
}
...
public class Lambda {
	public static void main(String[] args) {
		...
		//ChangeToUpper changeToUpper=(a) -> System.out.print(a.toUpperCase("hello"));
		
		oddeven oddeven =(a) -> a%2==0? "Even":"odd";
		Print printobj=(s)->System.out.println(s);
		Negorpov negorpovObj=(b)->{
			if(b<=0) {
		...
		//System.out.println(changeToUpper);
